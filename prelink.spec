...
* Fri Dec 27 2013 Daniel Mach <dmach@redhat.com> - 0.5.0-5
- Mass rebuild 2013-12-27

* Tue Dec 17 2013 Jakub Jelinek <jakub@redhat.com> 0.5.0-4
- set PRELINKING=no by default (#1039750)

* Sat Oct  5 2013 Jakub Jelinek <jakub@redhat.com> 0.5.0-3
- fix R_390_IRELATIVE handling on s390/s390x (#973259, #1010392, #1010398)
- change cron.daily/prelink permissions to rwxr-x--- (#1012538)

* Sun Aug  4 2013 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0.5.0-2
...
* Mon Dec 12 2005 Jakub Jelinek <jakub@redhat.com> 0.3.6-2
